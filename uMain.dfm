object frmMain: TfrmMain
  ...
  object pgcMain: TPageControl
    ...
    object tbsVisualizarPendencias: TTabSheet
      Caption = 'Visualizar Pendencias'
      ImageIndex = 5
      object lblListaArquivosProcessados: TLabel
        Left = 6
        Top = 22
        Width = 175
        Height = 13
        Caption = 'Lista de Arquivos Processados'
      end
      object lblListaDeArquivosPendentes: TLabel
        Left = 6
        Top = 234
        Width = 163
        Height = 13
        Caption = 'Lista de Arquivos Pendentes'
      end
      object lblTotalDeArquivosProcessados: TLabel
        Left = 4
        Top = 183
        Width = 707
        Height = 13
        Alignment = taRightJustify
        AutoSize = False
        Caption = 'lblTotalDeArquivosProcessados'
        Color = clBtnText
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -11
      ...
      object lblTotalDeArquivospendentes: TLabel
        Left = 6
        Top = 393
        Width = 704
        Height = 13
        Alignment = taRightJustify
        AutoSize = False
        Caption = 'lblTotalDeArquivosPendentes'
        Color = clBlack
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -11
      ...
      object chklstListaArquivosProcessados: TCheckListBox
        Left = 4
        Top = 38
        Width = 709
        Height = 143
      ...
      object lstListaDeArquivosPendentes: TListBox
        Left = 6
        Top = 249
        Width = 705
        Height = 143
      ...
      object btnSelecionarTodosTrack: TBitBtn
        Left = 277
        Top = 12
        Width = 109
        Height = 24
        ...
        ParentFont = False
        TabOrder = 4
        OnClick = btnSelecionarTodosTrackClick
        Glyph.Data = {
          36030000424D3603000000000000360000002800000010000000100000000100
          18000000000000030000130B0000130B00000000000000000000000000000000
          000000000000000000000000C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0FFFFFFFFFF
      ...
      object btnLimparSelecaoTrack: TBitBtn
        Left = 388
        Top = 12
        Width = 109
        Height = 24
        ...
        ParentFont = False
        TabOrder = 5
        OnClick = btnLimparSelecaoTrackClick
        Glyph.Data = {
          36030000424D3603000000000000360000002800000010000000100000000100
          18000000000000030000130B0000130B00000000000000000000FAFAFAFAFAFA
          FAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFAFA
      ...
      object btnExportarPendencias: TButton
        Left = 542
        Top = 415
        Width = 166
        Height = 25
        Caption = 'Exportar Pendencias'
        TabOrder = 7
        OnClick = btnExportarPendenciasClick
      end
    end
  end
  object tmrAtualizaDados: TTimer
    Interval = 10
    OnTimer = tmrAtualizaDadosTimer
    Left = 709
    Top = 9
  end
end
